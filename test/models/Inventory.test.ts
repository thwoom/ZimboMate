...
describe('Inventory Model', () => {
  const createTestItem = (id: string, name: string, weight: number = 1): Item => ({
    id,
    name,
    category: 'gear',
    tags: [],
  ...
  describe('addItem', () => {
    it('should add item to inventory', () => {
      ...
      const item = createTestItem('sword1', 'Iron Sword');
  ...
  describe('removeItem', () => {
    ...
    it('should remove item from quick slots', () => {
      let inventory = createEmptyInventory();
      const item = createTestItem('potion1', 'Health Potion');
  ...
  describe('getContainerItems', () => {
    it('should return items in specified container', () => {
      let inventory = createEmptyInventory();
      const sword = createTestItem('sword1', 'Iron Sword');
  ...
  describe('sortItems', () => {
    ...
    it('should sort by weight (descending)', () => {
      const sorted = sortItems(items, 'weight');
