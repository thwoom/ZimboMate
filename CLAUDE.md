...
1. 
pm run screenshot before large UI refactors to refresh baselines when appearance intentionally changes.
2. 
pm run screenshot:analyze after each feature branch to ensure no unintended diffs.
