...
This quick guide will get you up and running with ZimboMate V2 in just a few minutes. For complete details, see the [User Guide](./USER_GUIDE.md).
...
2. Fill in your character details:
   ...
   - **Class**: Choose your Dungeon World playbook
   - **Level**: Starting level (usually 1)
   - **Stats**: Set your six attributes (8-18 range)
...
4. See your results with Dungeon World success levels:
   - **10+**: Full Success ✅
...
4. Watch your **Load** (encumbrance) automatically update
...
1. **Character Ready**: Ensure your character sheet is complete
2. **Take Notes**: Use Session Tools > Notes for important information
3. **Track Bonds**: Add relationships with other characters
4. **Roll with Style**: Use the 3D dice for all your rolls
5. **Monitor Health**: Keep an eye on HP and debilities

### For Game Masters 🎭

1. **Create Campaign**: Go to Campaign tab and create your campaign
2. **Add NPCs**: Use the NPC Manager for important characters
3. **Track Sessions**: Record each session in Session History
4. **Use Multiplayer**: Share dice rolls with all players in real-time
5. **Take Notes**: Use Session Tools for campaign notes and tracking
...
- ✅ Ctrl+K finds anything instantly
