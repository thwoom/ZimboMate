...
- `docs/NEXT_STEPS.md` - Step-by-step tasks
- `main.tsx` - Entry point (uses App.Enhanced)

**RECENT ADDITIONS**:
- `src/App.Enhanced.tsx` - Main app with new features
- `src/components/ui/RollResultsToast.tsx` - Roll feedback
- `src/components/ui/NavigationRouter.tsx` - Navigation
- `src/components/ui/AuthContext.tsx` - User auth
- `src/hooks/useRollResults.ts` - Roll management
