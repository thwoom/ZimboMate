/* eslint-disable */
export type Token = `aspectRatios.${AspectRatioToken}` | `borders.${BorderToken}` | `letterSpacings.${LetterSpacingToken}` | `blurs.${BlurToken}` | `sizes.${SizeToken}` | `animations.${AnimationToken}` | `colors.${ColorToken}` | `spacing.${SpacingToken}` | `radii.${RadiusToken}` | `shadows.${ShadowToken}` | `durations.${DurationToken}` | `easings.${EasingToken}` | `zIndex.${ZIndexToken}` | `fonts.${FontToken}` | `fontSizes.${FontSizeToken}` | `fontWeights.${FontWeightToken}` | `lineHeights.${LineHeightToken}` | `breakpoints.${BreakpointToken}`

export type ColorPalette = "current" | "black" | "white" | "transparent" | "rose" | "pink" | "fuchsia" | "purple" | "violet" | "indigo" | "blue" | "sky" | "cyan" | "teal" | "emerald" | "green" | "lime" | "yellow" | "amber" | "orange" | "red" | "neutral" | "stone" | "zinc" | "gray" | "slate" | "background" | "foreground" | "muted" | "muted.foreground" | "primary" | "primary.foreground" | "secondary" | "secondary.foreground" | "accent" | "accent.foreground" | "destructive" | "destructive.foreground" | "success" | "success.foreground" | "warning" | "warning.foreground" | "border" | "input" | "ring" | "card" | "card.foreground" | "popover" | "popover.foreground" | "cosmic.bg" | "cosmic.fg" | "cosmic.primary" | "cosmic.secondary" | "cosmic.accent" | "cosmic.glow" | "cosmic.seam" | "moebius.bg" | "moebius.fg" | "moebius.primary" | "moebius.secondary" | "moebius.accent" | "moebius.outline" | "moebius.wire"
