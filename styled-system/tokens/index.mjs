const tokens = {
  ...
  "colors.foreground": {
    "value": "hsl(var(--color-foreground))",
    "variable": "var(--colors-foreground)"
  },
  "colors.muted": {
    "value": "hsl(var(--color-muted))",
    "variable": "var(--colors-muted)"
  },
  "colors.muted.foreground": {
    "value": "hsl(var(--color-muted-foreground))",
    "variable": "var(--colors-muted\\.foreground)"
  },
  "colors.primary": {
    "value": "hsl(var(--color-primary))",
    "variable": "var(--colors-primary)"
  },
  "colors.primary.foreground": {
    "value": "hsl(var(--color-primary-foreground))",
    "variable": "var(--colors-primary\\.foreground)"
  },
  "colors.secondary": {
    "value": "hsl(var(--color-secondary))",
    "variable": "var(--colors-secondary)"
  },
  "colors.secondary.foreground": {
    "value": "hsl(var(--color-secondary-foreground))",
    "variable": "var(--colors-secondary\\.foreground)"
  },
  "colors.accent": {
    "value": "hsl(var(--color-accent))",
    "variable": "var(--colors-accent)"
  },
  "colors.accent.foreground": {
    "value": "hsl(var(--color-accent-foreground))",
    "variable": "var(--colors-accent\\.foreground)"
  },
  "colors.destructive": {
    "value": "hsl(var(--color-destructive))",
    "variable": "var(--colors-destructive)"
  },
  "colors.destructive.foreground": {
    "value": "hsl(var(--color-destructive-foreground))",
    "variable": "var(--colors-destructive\\.foreground)"
  },
  "colors.success": {
    "value": "hsl(var(--color-success))",
    "variable": "var(--colors-success)"
  },
  "colors.success.foreground": {
    "value": "hsl(var(--color-success-foreground))",
    "variable": "var(--colors-success\\.foreground)"
  },
  "colors.warning": {
    "value": "hsl(var(--color-warning))",
    "variable": "var(--colors-warning)"
  },
  "colors.warning.foreground": {
    "value": "hsl(var(--color-warning-foreground))",
    "variable": "var(--colors-warning\\.foreground)"
  },
  "colors.border": {
    "value": "hsl(var(--color-border))",
    "variable": "var(--colors-border)"
  },
  "colors.input": {
    "value": "hsl(var(--color-input))",
    "variable": "var(--colors-input)"
  },
  "colors.ring": {
    "value": "hsl(var(--color-ring))",
    "variable": "var(--colors-ring)"
  },
  "colors.card": {
    "value": "hsl(var(--color-card))",
    "variable": "var(--colors-card)"
  },
  "colors.card.foreground": {
    "value": "hsl(var(--color-card-foreground))",
    "variable": "var(--colors-card\\.foreground)"
  },
  "colors.popover": {
    "value": "hsl(var(--color-popover))",
    "variable": "var(--colors-popover)"
  },
  "colors.popover.foreground": {
    "value": "hsl(var(--color-popover-foreground))",
    "variable": "var(--colors-popover\\.foreground)"
  },
  "colors.cosmic.bg": {
    "value": "hsl(var(--color-cosmic-bg))",
    "variable": "var(--colors-cosmic\\.bg)"
  },
  "colors.cosmic.fg": {
    "value": "hsl(var(--color-cosmic-fg))",
    "variable": "var(--colors-cosmic\\.fg)"
  },
  "colors.cosmic.primary": {
    "value": "hsl(var(--color-cosmic-primary))",
    "variable": "var(--colors-cosmic\\.primary)"
  },
  "colors.cosmic.secondary": {
    "value": "hsl(var(--color-cosmic-secondary))",
    "variable": "var(--colors-cosmic\\.secondary)"
  },
  "colors.cosmic.accent": {
    "value": "hsl(var(--color-cosmic-accent))",
    "variable": "var(--colors-cosmic\\.accent)"
  },
  "colors.cosmic.glow": {
    "value": "hsl(var(--color-cosmic-glow))",
    "variable": "var(--colors-cosmic\\.glow)"
  },
  "colors.cosmic.seam": {
    "value": "hsl(var(--color-cosmic-seam))",
    "variable": "var(--colors-cosmic\\.seam)"
  },
  "colors.moebius.bg": {
    "value": "hsl(var(--color-moebius-bg))",
    "variable": "var(--colors-moebius\\.bg)"
  },
  "colors.moebius.fg": {
    "value": "hsl(var(--color-moebius-fg))",
    "variable": "var(--colors-moebius\\.fg)"
  },
  "colors.moebius.primary": {
    "value": "hsl(var(--color-moebius-primary))",
    "variable": "var(--colors-moebius\\.primary)"
  },
  "colors.moebius.secondary": {
    "value": "hsl(var(--color-moebius-secondary))",
    "variable": "var(--colors-moebius\\.secondary)"
  },
  "colors.moebius.accent": {
    "value": "hsl(var(--color-moebius-accent))",
    "variable": "var(--colors-moebius\\.accent)"
  },
  "colors.moebius.outline": {
    "value": "hsl(var(--color-moebius-outline))",
    "variable": "var(--colors-moebius\\.outline)"
  },
  "colors.moebius.wire": {
    "value": "hsl(var(--color-moebius-wire))",
    "variable": "var(--colors-moebius\\.wire)"
  },
  "spacing.0": {
    "value": "0rem",
  ...
  "spacing.hud.gap": {
    "value": "var(--space-hud-gap)",
    "variable": "var(--spacing-hud\\.gap)"
  },
  "spacing.hud.padding": {
    "value": "var(--space-hud-padding)",
    "variable": "var(--spacing-hud\\.padding)"
  },
  "spacing.hud.margin": {
    "value": "var(--space-hud-margin)",
    "variable": "var(--spacing-hud\\.margin)"
  },
  "spacing.panel.gap": {
    "value": "var(--space-panel-gap)",
    "variable": "var(--spacing-panel\\.gap)"
  },
  "radii.xs": {
    "value": "0.125rem",
  ...
  "radii.hud": {
    "value": "var(--radius-hud)",
    "variable": "var(--radii-hud)"
  },
  "radii.panel": {
    "value": "var(--radius-panel)",
  ...
  "shadows.hud": {
    "value": "var(--shadow-hud)",
    "variable": "var(--shadows-hud)"
  },
  "shadows.panel": {
    "value": "var(--shadow-panel)",
  ...
  "durations.slower": {
    "value": "var(--motion-duration-slower)",
  ...
  "easings.bounce": {
    "value": "var(--motion-ease-bounce)",
    "variable": "var(--easings-bounce)"
  },
  "zIndex.dropdown": {
    "value": "var(--z-dropdown)",
  ...
  "zIndex.hud-overlay": {
    "value": "var(--z-hud-overlay)",
    "variable": "var(--z-index-hud-overlay)"
  },
  "fonts.serif": {
  ...
  "spacing.-hud.gap": {
    "value": "calc(var(--spacing-hud\\.gap) * -1)",
    "variable": "var(--spacing-hud\\.gap)"
  },
  "spacing.-hud.padding": {
    "value": "calc(var(--spacing-hud\\.padding) * -1)",
    "variable": "var(--spacing-hud\\.padding)"
  },
  "spacing.-hud.margin": {
    "value": "calc(var(--spacing-hud\\.margin) * -1)",
    "variable": "var(--spacing-hud\\.margin)"
  },
  "spacing.-panel.gap": {
    "value": "calc(var(--spacing-panel\\.gap) * -1)",
    "variable": "var(--spacing-panel\\.gap)"
  },
  "colors.colorPalette": {
