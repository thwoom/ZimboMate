...
import { Item, Weapon, Armor, ItemCategory } from '../models/Equipment';
...
export const CLASS_BOND_TEMPLATES: Record<CharacterClass, string[]> = {
  Fighter: [
    ...
    "____ and I have fought side by side."
  ],
  Paladin: [
    "____ has stood by me in battle and can be trusted completely.",
    "I respect the beliefs of ____.",
    "____ is a brave soul, I have much to learn from them.",
    "____ has insulted my deity; I must show them the true way."
  ],
  Ranger: [
    "____ guided me when I first entered the city.",
    "I have shown ____ a secret rite of the Land.",
  ...
  Wizard: [
    ...
    "____ has been my apprentice. I taught them the basics of magic.",
    "____ witnessed me breaking the fundamental laws of magic. They saw me summon something I shouldn't have."
  ],
  Cleric: [
    "____ has insulted my deity; I must show them the true way.",
    "____ is a good and faithful person; I trust them implicitly.",
    "I have ministered to ____; they have seen me at my most vulnerable.",
    "____ is in grave danger. My deity has revealed this to me in a vision."
  ],
  Druid: [
  ...
  Thief: [
    "____ and I pulled off a job together.",
    "____ hired me to steal something.",
    "____ has my back when things go wrong.",
    "____ knows I stole something important from them."
  ],
  Barbarian: [
    ...
    "____ shares my hunger for glory; the earth will tremble at our deeds!"
  ],
  Immolator: [
    "____ has felt the hellish touch of fire, now they know my strength.",
    "I will teach ____ the true meaning of sacrifice.",
    "I cast something into the fire for ____ and the ashes still sing their name.",
    "____ will be the first sacrifice to the conflagration."
  ]
};