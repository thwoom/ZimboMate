...
/**
 * Calculate max total spell levels for preparation (official DW rule)
 * Both Wizards and Clerics use: character level + 1
 */
export function calculateMaxSpellLevels(
  characterClass: CharacterClass,
  level: number,
): number {
...
/**
 * Calculate total spell levels used by a list of prepared spells
 */
