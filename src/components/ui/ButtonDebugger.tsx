        ...
        <CardContent>
          <div className="flex flex-wrap gap-4">
            ...
            >
              <SwordIcon size={16} />
              Destructive (
              {clickCounts.destructive || 0}
              )
            </Button>

            <Button
              variant="magical"
              onClick={() => handleClick('magical')}
            >
              <SparklesIcon size={16} />
              Magical (
              {clickCounts.magical || 0}
              )
            </Button>

            <Button
              variant="cyber"
              onClick={() => handleClick('cyber')}
            >
              <WandIcon size={16} />
              Cyber (
              {clickCounts.cyber || 0}
      ...
      <Card>
        ...
        <CardContent>
          <div className="flex items-center flex-wrap gap-4">
            ...
            >
              Large (
              {clickCounts['size-lg'] || 0}
              )
            </Button>

            <Button
              size="xl"
              onClick={() => handleClick('size-xl')}
            >
              Extra Large (
              {clickCounts['size-xl'] || 0}
              )
            </Button>
