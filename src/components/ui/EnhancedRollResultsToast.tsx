                    ...
                    {pendingConsequences
                      ...
                      .map((consequence) => (
                        ...
                        >
                          <div
                            style={{
                              color: getConsequenceColor(consequence.type),
                            }}
                          >
                          ...
                          {manualConsequences.map((consequence) => (
                            ...
                            >
                              <input
                                type='checkbox'
                                id={consequence.id}
                                checked={selectedConsequences.includes(
                                  consequence.id,
                                )}
                                onChange={() =>
                                  handleConsequenceToggle(consequence.id)
                                }
                                className='mt-0.5'
                              />
                              <label
