    ...
    <div className='space-y-6'>
          ...
          <div className='flex flex-col sm:flex-row gap-4'>
            ...
            >
              ...
              <Select.Content className='bg-surface border border-border rounded-lg shadow-lg z-50 bg-card'>
                <Select.Item
                  value='all'
                  className='p-2 hover:bg-surface-elevated cursor-pointer'
                >
                  All Files
                </Select.Item>
                <Select.Item
                  value={FileType.CHARACTER}
                  className='p-2 hover:bg-surface-elevated cursor-pointer'
                >
                  Characters
                </Select.Item>
                <Select.Item
                  value={FileType.CAMPAIGN}
                  className='p-2 hover:bg-surface-elevated cursor-pointer'
                >
                  Campaigns
                </Select.Item>
            ...
            <div className='flex items-center justify-between'>
              ...
              <div className='flex gap-2'>
                <Button
                  ...
                  size='sm'
                  onClick={() =>
                    handleFileOperation(FileOperation.EXPORT, selectedFiles)
                  }
                ...
                <Button
                  ...
                  size='sm'
                  onClick={() =>
                    handleFileOperation(FileOperation.DELETE, selectedFiles)
                  }
                  disabled={!!operationInProgress}
                >
                  Delete Selected
                    ...
                    return (
                      ...
                      >
                        <ContextMenu.Root>
                          ...
                          <ContextMenu.Portal>
                            <ContextMenu.Content className='bg-surface border border-border rounded-lg shadow-lg p-1 z-50 bg-card'>
                              <ContextMenu.Item
      ...
      >
        <Dialog.Portal>
          ...
          <Dialog.Content className='fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-2xl max-h-[80vh] p-6 rounded-lg shadow-lg z-50 overflow-auto bg-card'>
            {previewFile && (
              <>
                ...
                <div className='space-y-4'>
                  ...
                  <div className='p-4 rounded-lg font-mono text-sm bg-popover'>
