...
export const BackupPanel: React.FC<BackupPanelProps> = ({
  ...
  const frequencyOptions = [
    ...
    },
    {
      ...
      label: 'Weekly',
      description: 'Backup every Sunday at 3:00 AM',
    },
    {
      value: BackupFrequency.MONTHLY,
      label: 'Monthly',
      description: 'Backup on the 1st of each month',
    },
    {
    ...
    <div className='space-y-6'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
        ...
        <Card variant='surface'>
          <CardContent className='text-center py-6'>
            ...
            <p className='text-2xl font-bold text-primary'>
              {formatFileSize(
                mockFileManagement.backupHistory.reduce(
        ...
        <Card variant='surface'>
          <CardContent className='text-center py-6'>
            ...
            <p className='text-sm font-medium text-primary'>
              {mockFileManagement.backupHistory[0]?.created.toLocaleDateString() ||
                'Never'}
            </p>
          </CardContent>
        </Card>
      ...
      >
        <AlertDialog.Portal>
          ...
          <AlertDialog.Content className='fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-md p-6 rounded-lg shadow-lg z-50 bg-card'>
