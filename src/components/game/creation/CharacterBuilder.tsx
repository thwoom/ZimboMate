  ...
  const StandardArrayAssign: React.FC = () => {
    ...
    return (
      <div className="space-y-4">
        <div className="text-sm text-muted-foreground">Standard Array: {pool.join(', ')}</div>
      ...
      <CardContent>
                ...
                <Button
                  ...
                  onClick={() => {
                    setDraft(d => {
                      ...
                      const newDraft = { ...d, class: cls, race: newRace, alignment: newAlignment }
        ...
        {step === 'gear' && (
          <div className="space-y-4">
            {draft.class ? (
              <>
                <div className="text-sm text-muted-foreground">Starting gear ({draft.class})</div>
