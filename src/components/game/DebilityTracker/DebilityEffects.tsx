...
export const DebilityEffects: React.FC<DebilityEffectsProps> = ({
  ...
  const normalizedAttributes = (
    Object.keys(character.attributes) as Attribute[]
  ).reduce(
    (acc, key) => {
  ...
  const attributeEffects = (Object.keys(character.attributes) as Attribute[])
    .map((attr) => {
  ...
  const totalPenalty = attributeEffects.reduce(
    (sum, effect) => sum + effect.penalty,
    0,
  )
        ...
        <CardContent>
          <div className='space-y-4'>
            ...
            <div className='flex items-center justify-between'>
              ...
              >
                <Dice6 size={12} />-{totalPenalty} to rolls
              </Badge>
            </div>
              ...
              <div className='flex items-start gap-3'>
                ...
                <div>
                  ...
                  <p className='text-sm text-chart-4'>
                    When making moves that use affected attributes, you'll roll
                    2d6 with reduced modifiers. This makes success (10+) harder
                    to achieve and increases the chance of failure (6-).
                  </p>
                  {totalPenalty >= 3 && (
                    <p className='text-sm text-destructive mt-2 font-medium'>
                      ⚠️ Warning: Multiple debilities are severely impacting
            ...
            <div className='text-center p-3 bg-primary/10 rounded-lg'>
              <p className='text-sm text-primary'>
                <strong>Remember:</strong> Debilities can be healed through
                rest, medical attention, magical healing, or specific moves.
                Work with your GM to find ways to recover!
              </p>
            </div>
          </div>
        </CardContent>
