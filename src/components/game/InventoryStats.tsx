          ...
          <CardContent>
            <div className='grid grid-cols-2 md:grid-cols-4 gap-4'>
              ...
              <div className='text-center p-4 bg-(--parchment-100) rounded-lg border border-(--parchment-300)'>
                <Weight
                  size={24}
                  className={`mx-auto mb-2 ${getEncumbranceColor(weightPercentage)}`}
                />
              ...
              <div className='text-center p-4 bg-(--parchment-100) rounded-lg border border-(--parchment-300)'>
                <Package
                  size={24}
                  className='mx-auto mb-2 text-(--parchment-700)'
                />
                <div className='space-y-1'>
                  <p className='text-lg font-bold text-(--parchment-900) font-mono'>
                    {stats.itemCount}
              ...
              <div className='text-center p-4 bg-(--parchment-100) rounded-lg border border-(--parchment-300)'>
                <div className='mb-2'>
                  <div className='w-12 h-12 mx-auto rounded-full bg-(--parchment-200) flex items-center justify-center'>
                    <span
                      className={`text-sm font-bold font-mono ${getEncumbranceColor(weightPercentage)}`}
                    >
            ...
            <div className='space-y-4'>
              ...
              <div className='grid grid-cols-3 gap-4 text-center text-xs'>
                ...
                <div>
                  ...
                  <span className='text-(--parchment-600) font-ui'>
                    Encumbered
                  </span>
                  <p className='font-mono text-(--parchment-800)'>
              ...
              {stats.encumbranceStatus !== 'normal' && (
                ...
                >
                  {stats.encumbranceStatus === 'encumbered' && (
                    <p>
                      <strong>Encumbered:</strong> You take -1 ongoing to all
                      rolls until you lighten your load.
                    </p>
                  )}
                  {stats.encumbranceStatus === 'overloaded' && (
                    <p>
                      <strong>Overloaded:</strong> You can barely move. Drop
                      items or find another way to reduce your load.
                    </p>
                  )}
                </motion.div>
              )}
