...
export function SpellBook({
  ...
  const handleSpellPrepare = useCallback(
  ...
  const handleSpellCast = useCallback(
    async (spellId: string, level: number) => {
      const spell = allSpells.find((s) => s.id === spellId)
      if (!spell) return
                    ...
                    <div className='h-full flex flex-col'>
                      <SpellSearch
                        ...
                        onSearchChange={(value) =>
                          dispatch({ type: 'setSearch', query: value })
                        }
                        selectedSchool={selectedSchool}
                        onSchoolChange={(value) =>
                          dispatch({ type: 'setSchool', school: value })
                        }
                        selectedLevel={selectedLevel}
                        onLevelChange={(value) =>
                          dispatch({ type: 'setLevel', level: value })
                        }
