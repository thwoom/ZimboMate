...
export default function FolioStatsPage({ highlighted = false }: FolioStatsPageProps): JSX.Element {
    ...
    <div className='grid gap-3 md:grid-cols-2'>
      <Card className={cn(highlighted && 'ring-2 ring-primary/60')}>
        <CardContent className='p-3'>
          <h3 className='text-foreground mb-2 text-sm font-medium'>Attributes</h3>
      ...
      <Card className={cn(highlighted && 'ring-2 ring-primary/60')}>
        <CardContent className='p-3'>
          <h3 className='text-foreground mb-2 text-sm font-medium'>Basic Moves</h3>
          <MoveChips onSelect={() => { /* composer integration */ }} />
        </CardContent>
      </Card>
    </div>
  )
