    ...
    >
      ...
      <div className='flex flex-col sm:flex-row gap-3'>
        ...
        <ToggleGroup.Root
          ...
          value={inventoryView}
          onValueChange={(value) =>
            value && setInventoryView(value as InventoryView)
          }
          className='flex border border-(--parchment-300) rounded-lg p-1 bg-card'
        >
          <ToggleGroup.Item
            value='grid'
            className='flex items-center gap-1 px-3 py-2 text-sm rounded-md transition-colors data-[state=on]:bg-primary data-[state=on]:text-white hover:bg-(--parchment-100)'
          >
            <Grid3X3 size={14} />
      ...
      <div className='flex flex-col sm:flex-row gap-3'>
        ...
        <div className='flex-1'>
          <Select.Root
            value={filterBy}
            onValueChange={(value) => setFilterBy(value as InventoryFilter)}
          >
                ...
                <Select.Viewport className='p-1'>
                  {filterOptions.map((option) => (
                    <Select.Item
                      key={option.value}
                      value={option.value}
                      className='flex items-center px-3 py-2 text-sm rounded-md cursor-pointer hover:bg-(--parchment-100) focus:bg-(--parchment-100) outline-none data-[state=checked]:bg-primary data-[state=checked]:text-white'
                    >
