...
import { Campaign, CampaignSession, JournalEntry, NPC, Location, createCampaign, createSession, createJournalEntry, createNPC, createLocation } from '../models/Campaign';
...
export class CampaignService {
  ...
  private saveToStorage(): void {
    try {
      const data = Array.from(this.campaigns.entries());
