...
export const EquipmentSlot: React.FC<EquipmentSlotProps> = ({
  ...
  if (equippedItem) {
    return (
      <Tooltip.Root>
          ...
          >
            ...
            >
              <Button
                variant="ghost"
                size="icon"
                className="h-6 w-6 text-(--parchment-600) hover:text-(--danger-600) bg-(--color-surface)/80 backdrop-blur-sm"
        ...
        <Tooltip.Portal>
          <Tooltip.Content
            className="bg-(--color-surface) border border-(--parchment-300) rounded-lg p-3 shadow-lg z-50 max-w-xs"
            sideOffset={5}
          >
  ...
  return (
    <Tooltip.Root>
      ...
      <Tooltip.Portal>
        <Tooltip.Content
          className="bg-(--color-surface) border border-(--parchment-300) rounded-lg p-2 shadow-lg z-50"
          sideOffset={5}
        >
