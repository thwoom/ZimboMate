    ...
    <Card variant="magical" padding="lg" className="relative overflow-hidden">
      ...
      <CardContent className="text-center space-y-6">
        <div className="flex items-center justify-center gap-4">
          ...
          {modifier !== 0 && (
            <div className="flex items-center gap-1 text-sm font-mono bg-(--color-surface-elevated) px-2 py-1 rounded">
        ...
        <div className="flex items-center justify-center gap-6">
          ...
          <motion.div
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
            className="text-2xl font-display text-(--color-text-muted)"
          >
            +
          </motion.div>
