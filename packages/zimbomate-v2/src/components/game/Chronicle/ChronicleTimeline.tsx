          ...
          >
            ...
            >
              ...
              {index < filteredEntries.length - 1 && (
                <div
                  className="absolute left-6 -bottom-4 w-0.5 h-8 z-10"
              ...
              <div
                ...
                style={{
                  backgroundColor: entry.isSceneBreak ? 'var(--color-primary)' : 'var(--color-surface)',
                  borderColor: entry.isSceneBreak ? 'var(--color-primary)' : 'var(--color-border)'
                }}
              >
                {entry.isSceneBreak && (
                  <Sparkles size={8} className="absolute top-0.5 left-0.5 text-white" />
                )}
              </div>
              ...
              <CardContent className="ml-8">
                <div className="space-y-4">
                  ...
                  {(entry.narrativeContext || entry.emotionalTone) && (
                    <div className="pt-2 border-t text-xs" style={{ borderColor: 'var(--color-border)' }}>
