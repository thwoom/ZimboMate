                  ...
                  <CardContent>
                    <div className="space-y-3">
                        ...
                        <div>
                          <div className="flex items-center gap-2">
                            ...
                            {isTimerExpired(timer) && (
                              <Badge variant="default" className="bg-red-100 text-red-800 gap-1">
                                <Bell size={10} />
                                Expired
                              </Badge>
                            )}
                      ...
                      <div className="text-center">
                        <div className={`text-2xl font-bold ${isTimerExpired(timer) ? 'text-red-600' : ''}`}>
                        ...
                        <div className="w-full bg-gray-200 rounded-full h-2">
                          <div 
                            className={`h-2 rounded-full transition-all duration-300 ${
                              isTimerExpired(timer) ? 'bg-red-500' : 'bg-blue-500'
                            }`}
