                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      min="0"
                      max="10"
                      className={errors.xpGained ? 'border-red-500' : ''}
                    />
                    {errors.xpGained && (
                      <p className="text-red-500 text-sm">{errors.xpGained}</p>
                    )}
                  </div>
                </div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {formData.highlights.map((highlight, index) => (
                        <Badge
                          key={index}
                          variant="secondary"
                          className="text-xs cursor-pointer hover:bg-yellow-500/20 bg-yellow-500/10 text-yellow-700"
