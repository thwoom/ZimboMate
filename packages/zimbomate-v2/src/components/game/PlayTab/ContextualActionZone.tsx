  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        <h3 className="text-xl font-display text-red-600 mb-2">⚔️ Combat Mode</h3>
...
const ExplorationMode: React.FC<{
  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        <h3 className="text-xl font-display text-green-600 mb-2">🗺️ Exploration Mode</h3>
        <p className="text-sm text-gray-600 dark:text-gray-400">
...
const SocialMode: React.FC<{
  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        <h3 className="text-xl font-display text-blue-600 mb-2">🤝 Social Mode</h3>
        <p className="text-sm text-gray-600 dark:text-gray-400">
...
const RestMode: React.FC<{
  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        <h3 className="text-xl font-display text-purple-600 mb-2">🏕️ Rest Mode</h3>
        <p className="text-sm text-gray-600 dark:text-gray-400">
