  ...
  return (
    <div className="space-y-2">
      <div className="flex items-center justify-between text-sm">
        ...
        <span className={`font-mono ${isOverloaded ? 'text-red-500' : ''}`}>
          {current}/{max}
        </span>
      </div>
      ...
      <div className="relative h-2 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
        ...
        {isOverloaded && (
          <motion.div
            className="absolute top-0 right-0 h-full bg-red-600"
...
export const CharacterStatusWidget: React.FC<CharacterStatusWidgetProps> = ({
  ...
  const statusEffects = [
    // Example debilities
    ...(character.debilities?.weak ? [{ type: 'debility', name: 'Weak', icon: <Droplets size={12} />, color: 'bg-red-500' }] : []),
    ...(character.debilities?.shaky ? [{ type: 'debility', name: 'Shaky', icon: <Wind size={12} />, color: 'bg-yellow-500' }] : []),
    ...
    >
      <CardContent className="h-full flex flex-col">
        ...
        <div className="text-center mb-4">
          <motion.div
            className="w-12 h-12 mx-auto mb-2 rounded-full bg-gradient-to-br from-blue-400 to-purple-600 flex items-center justify-center text-white font-bold text-lg"
        ...
        {statusEffects.length > 0 && (
          <div className="mt-4">
            <div className="text-xs text-gray-500 mb-2">Status Effects</div>
        ...
        <div className="mt-4 pt-3 border-t border-gray-200 dark:border-gray-700">
          <Badge
            ...
            className={`w-full justify-center text-xs ${
              gameMode === 'combat' ? 'bg-red-100 text-red-700' :
              gameMode === 'exploration' ? 'bg-green-100 text-green-700' :
              gameMode === 'social' ? 'bg-blue-100 text-blue-700' :
