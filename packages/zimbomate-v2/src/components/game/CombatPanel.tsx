...
export const CombatPanel: React.FC<CombatPanelProps> = ({
  ...
  const handleAttack = (attackerId: string, targetId: string) => {
    // Roll Hack and Slash or similar move
    onRollMove?.('Hack and Slash', 'hack-and-slash', targetId)
  }
        ...
        <CardContent className="text-center space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-(--color-text-secondary)">
              Start a combat encounter to track initiative, damage, and conditions
            </p>
          </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div className="text-center">
                <div className="text-sm text-(--color-text-secondary)">Current Turn</div>
        ...
        <div className="grid gap-3">
          {currentEncounter.participants.map((participant, index) => (
            <motion.div
              ...
              className={`relative ${
                index === currentEncounter.currentTurn ? 'ring-2 ring-(--color-primary)' : ''
              }`}
            >
                    ...
                    <div className="flex items-center gap-3">
                      <div className="relative">
                        ...
                        {index === currentEncounter.currentTurn && (
                          <div className="absolute -inset-1 rounded-full border-2 border-(--color-primary) animate-pulse" />
                        )}
                      </div>
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-4 text-sm text-(--color-text-secondary)">
                          ...
                          <span className="capitalize">{participant.position}</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className="flex items-center gap-1">
                        <Button
                          variant="ghost"
                          size="sm"
                          onClick={() => handleDamageParticipant(participant.id, 1)}
                        ...
                        <Button
                          variant="ghost"
                          size="sm"
                          onClick={() => handleHealParticipant(participant.id, 1)}
                          disabled={participant.hp.current >= participant.hp.max}
                        >
                          <Plus size={12} />
                        </Button>
                      </div>
                      ...
                      {participant.hp.current > 0 && (
                        <div className="flex items-center gap-1">
                          <Button
                            variant="ghost"
                            size="sm"
                            onClick={() => onRollMove?.('Attack', 'hack-and-slash', participant.id)}
                          ...
                          <Button
                            variant="ghost"
                            size="sm"
                            onClick={() => onRollDamage?.('Weapon', [Math.floor(Math.random() * 8) + 1])}
                            title="Roll damage"
                          >
                            <Dice6 size={12} />
                          </Button>
                ...
                <CardContent className="p-6 space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div>
                        <label className="block text-sm font-medium mb-1">Armor</label>
                        <input
                          type="number"
          ...
          <CardContent className="p-4 text-center">
            <div className="space-y-2">
              ...
              <p className="text-sm text-(--color-text-secondary)">
                The battle has ended. You can review the results or start a new encounter.
              </p>
