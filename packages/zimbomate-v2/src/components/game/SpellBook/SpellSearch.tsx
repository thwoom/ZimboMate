  ...
  return (
    ...
    >
      ...
      <div className="relative">
        <Search size={16} className="absolute left-3 top-1/2 transform -translate-y-1/2 text-parchment-500" />
        <Input
          type="text"
      ...
      <div className="flex gap-3">
        ...
        <div className="flex-1">
          <Select.Root
            ...
            onValueChange={(value) => onLevelChange(value ? parseInt(value) : null)}
          >
            <Select.Trigger className="w-full flex items-center justify-between px-3 py-2 text-ui-regular bg-parchment-100 border border-parchment-300 rounded-lg hover:border-gold-400 focus:outline-none focus:ring-2 focus:ring-gold-400">
      ...
      {hasActiveFilters && (
        ...
        >
          ...
          {selectedSchool && (
            <div className="px-2 py-1 bg-magic-100 text-magic-800 rounded text-ui-small">
              School: {selectedSchool.charAt(0).toUpperCase() + selectedSchool.slice(1)}
            </div>
          )}
          {selectedLevel !== null && (
