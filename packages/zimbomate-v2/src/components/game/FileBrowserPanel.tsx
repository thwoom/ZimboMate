    ...
    <div className="space-y-6">
                    ...
                    return (
                      ...
                      >
                        <ContextMenu.Root>
                          ...
                          <ContextMenu.Portal>
                            <ContextMenu.Content 
                              className="bg-surface border border-border rounded-lg shadow-lg p-1 z-50"
                              style={{ backgroundColor: 'var(--color-surface)' }}
                            >
                              <ContextMenu.Item 
                              ...
                              <ContextMenu.Item 
                                className="flex items-center gap-2 px-3 py-2 hover:bg-red-100 text-red-600 cursor-pointer rounded"
      ...
      <Dialog.Root open={!!previewFile} onOpenChange={() => setPreviewFile(null)}>
        <Dialog.Portal>
          ...
          <Dialog.Content 
            className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-2xl max-h-[80vh] p-6 rounded-lg shadow-lg z-50 overflow-auto"
            style={{ backgroundColor: 'var(--color-surface)' }}
          >
            {previewFile && (
              <>
