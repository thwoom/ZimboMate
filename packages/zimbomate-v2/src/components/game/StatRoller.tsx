  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="text-xs text-center text-gray-600 dark:text-gray-400 leading-tight">
          {info.description}
        </div>
    ...
    <div className={`space-y-6 ${className}`}>
      ...
      <div className="text-center">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400">
          ...
          {characterName && <span className="block text-blue-600 dark:text-blue-400 mt-1">for {characterName}</span>}
        </p>
      </div>
      ...
      <div className="text-center space-y-2">
        <p className="text-xs text-gray-500 dark:text-gray-400">
          When you roll, you'll be prompted to chronicle why you needed to test that attribute
        </p>
        <div className="flex items-center justify-center gap-4 text-xs">
          <span className="text-green-600">10+ Success</span>
          <span className="text-yellow-600">7-9 Partial</span>
          <span className="text-red-600">6- Failure (XP)</span>
        </div>
      </div>
    </div>
  )
