    ...
    <div className={className}>
      ...
      {enableChronicleIntegration && (
        <div className="mt-4 flex items-center justify-center">
          <div className="flex items-center gap-2 text-xs px-3 py-1 rounded-full bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400">
            <div className={`w-2 h-2 rounded-full ${isOverlayEnabled ? 'bg-green-500' : 'bg-gray-400'}`} />
            <span>
