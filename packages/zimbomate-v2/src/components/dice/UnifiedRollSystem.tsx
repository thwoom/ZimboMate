      ...
      {(['STR', 'DEX', 'CON', 'INT', 'WIS', 'CHA'] as const).map(stat => {
        ...
        return (
          <RollableElement
            ...
            onRoll={onRoll}
            className="p-3 bg-white border-2 border-gray-200 rounded-lg hover:border-blue-300 transition-colors"
          >
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="border-t pt-4">
        <h4 className="text-sm font-medium text-gray-700 mb-2">Quick Custom Rolls</h4>
        <div className="grid grid-cols-2 gap-2">
          {[
            ...
            <button
              ...
              className="p-2 text-sm bg-gray-100 hover:bg-gray-200 rounded border transition-colors"
            >
              {preset.label}
            </button>
          ))}
...
export const UnifiedRollSystem: React.FC<UnifiedRollSystemProps> = ({
  ...
  const layoutClasses = {
    sidebar: 'flex h-screen bg-gray-50',
    modal: 'fixed inset-0 z-50 flex items-center justify-center bg-black/50',
    inline: 'w-full',
    fullscreen: 'fixed inset-0 z-40 bg-white'
  }
            ...
            <AnimatePresence mode="wait">
              ...
              >
                {activeTab === 'stats' && character && (
                  <div>
                    <div className="mb-6">
                      <h2 className="text-lg font-semibold text-gray-900 mb-2">Ability Scores</h2>
                      <p className="text-sm text-gray-600">Click any stat to roll 2d6 + modifier</p>
                    </div>
                    <StatRollPanel
                      characterId={characterId}
                      character={character}
                ...
                {activeTab === 'moves' && character && (
                  <div>
                    <div className="mb-6">
                      <h2 className="text-lg font-semibold text-gray-900 mb-2">Basic Moves</h2>
                      <p className="text-sm text-gray-600">Click any move to roll with the appropriate stat</p>
                    </div>
                    <MoveRollPanel
                      characterId={characterId}
                      character={character}
                ...
                {activeTab === 'custom' && (
                  <div>
                    <div className="mb-6">
                      <h2 className="text-lg font-semibold text-gray-900 mb-2">Custom Rolls</h2>
                      <p className="text-sm text-gray-600">Create custom dice rolls with modifiers</p>
                    </div>
                    <CustomRollPanel
                      characterId={characterId}
                      onRoll={handleRollResult}
