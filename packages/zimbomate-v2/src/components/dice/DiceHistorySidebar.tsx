      ...
      >
        ...
        <div className="p-3">
          <div className="text-center">
            <Dices size={20} className="mx-auto mb-2 text-gray-500" />
      ...
      <div className="p-4 border-b border-gray-200 dark:border-gray-700">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2">
            <Dices size={20} className="text-blue-600" aria-hidden="true" />
        ...
        <div className="grid grid-cols-4 gap-2 mb-3">
          ...
          <div className="text-center">
            <div className="text-sm font-semibold text-green-600">{stats.successes}</div>
            <div className="text-xs text-gray-500">10+</div>
          </div>
          <div className="text-center">
            <div className="text-sm font-semibold text-yellow-600">{stats.partials}</div>
            <div className="text-xs text-gray-500">7-9</div>
          </div>
          <div className="text-center">
            <div className="text-sm font-semibold text-red-600">{stats.failures}</div>
        ...
        {showFilters && (
          ...
          >
            <div className="space-y-3">
              <div>
                <label className="text-xs font-medium text-gray-500 mb-1 block">Filter</label>
                <select
                  value={filter}
            ...
            filteredHistory.map((roll, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="border-b border-gray-100 dark:border-gray-700 p-3 hover:bg-gray-50 dark:hover:bg-gray-700 group"
                ...
                >
                  ...
                  <div className="mb-3">
                    ...
                    <div className="flex items-center gap-2 text-xs text-gray-600 dark:text-gray-400 mb-1">
                      <div className="flex items-center gap-1">
                        <motion.div
                          className="w-5 h-5 bg-gradient-to-br from-blue-100 to-blue-200 border border-blue-300 rounded shadow-sm text-blue-700 flex items-center justify-center text-xs font-bold"
                        ...
                        <span className="text-gray-400">{roll.modifier >= 0 ? '+' : ''}{roll.modifier}</span>
                        <span className="text-gray-400">=</span>
                        <span className={`font-semibold ${
                          roll.outcome === 'success' ? 'text-green-600' :
                          roll.outcome === 'partial' ? 'text-yellow-600' :
                          'text-red-600'
                        }`}>
                          {roll.finalResult}
                        </span>
                  ...
                  <div className="flex gap-1">
                    <Button
                      ...
                      className="text-xs px-2 py-1 h-6 hover:bg-blue-50 hover:text-blue-700"
                      disabled={isRolling}
                    >
                    ...
                    <div className="relative">
                      <Button
                        ...
                        className={`text-xs px-2 py-1 h-6 hover:bg-green-50 hover:text-green-700 ${
                          copiedRoll === roll.id ? 'bg-green-100 text-green-800' : ''
                        }`}
                      >
                        {copiedRoll === roll.id ? (
                          <>
                    ...
                    <div className="relative group">
                      <Button
                        variant="ghost"
                        size="sm"
                        className="text-xs px-1 py-1 h-6 hover:bg-gray-100"
                      >
                        <MoreHorizontal size={10} />
                      </Button>

                      {/* Dropdown Menu */}
                      <div className="absolute right-0 top-full mt-1 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-600 py-1 min-w-[140px] opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                        <button
