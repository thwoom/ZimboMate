      ...
      >
        ...
        <AnimatePresence>
          {showHoverDice && isHovered && !disabled && (
            ...
            >
              <div className="bg-gray-800 text-white text-xs px-2 py-1 rounded-full flex items-center gap-1 shadow-lg border border-gray-600">
                <Dices size={12} />
                2d6
                {showModifier && (
          ...
          {isRolling && (
            ...
            >
              <motion.div
                ...
                className="relative"
              >
                <Dices className="text-gray-600 drop-shadow-sm" size={18} />
                {/* Subtle glow effect */}
        ...
        {showRightClickMenu && (
          <>
            ...
            <motion.div
              ...
              className="fixed z-50 bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-600 py-2 min-w-[200px]"
              style={{
