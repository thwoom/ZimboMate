...
import type { DiceRoll, RollModifiers } from '../services/DiceRollingService'
...
export const DiceRoller: React.FC <DiceRollerProps> = ({
  ...
  const handleRoll = async () => {
    if (!character || !move || disabled || isRolling)
      return
    ...
    setTimeout(() => {
      try {
        ...
        const statToUse = selectedStat || move.rollStat
        const _roll = diceRollingService.rollStat(statToUse as string, character, {
