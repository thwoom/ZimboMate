...
import { LevelUpResult,SpecialMovesService } from '../services/SpecialMovesService';
        ...
        <div className="modal-content">
          {!canLevelUp ? (
            <div className="level-up-error">
              ...
              <p > You need {nextLevelXP-character.xp} more XP to reach level {character.level + 1}.</p>

              <div className="xp-progress">
                <div className="xp-progress-label">
                  XP Progress: {character.xp} / {nextLevelXP}
                </div>
            ...
            <>
              <div className="level-up-success">
                ...
                <p>{character.name} has reached level {character.level + 1}!</p>
