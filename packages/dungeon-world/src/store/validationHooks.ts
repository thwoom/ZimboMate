 ...
 */
export function useValidatedCharacterUpdate() {
 ...
 */
export function useValidatedItemOperations() {
 ...
 */
export function useValidatedMoveOperations() {
 ...
 */
export function useGameStateValidation() {
