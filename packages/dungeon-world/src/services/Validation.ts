...
import type { EncumbranceStatus, Inventory } from '../models/Inventory'
...
export const CharacterValidation = {
  ...
  validateCharacter(character: Character): ValidationResult {
    ...
    const _expectedBaseHP = getClassBaseHP(character.class)
    const _expectedBaseLoad = getClassBaseLoad(character.class)
...
export const BusinessRules = {
  ...
  applyDebilityEffects(character: Character): Character {
    ...
    // This is here for unknown additional debility effects
    return character
  },
