import type { Alignment, Attributes, CharacterClass, Race } from '../models/Character'

// Name generation data
const FIRST_NAMES = {
  human: {
    male: ['Aldric', 'Bram', 'Cade', 'Darius', 'Edmund', 'Felix', 'Gareth', 'Hugo', 'Ivan', 'Jasper', 'Kieran', 'Leon', 'Marcus', 'Nolan', 'Oscar', 'Pierce', 'Quinn', 'Roland', 'Silas', 'Tobias'],
    female: ['Aria', 'Brenna', 'Cara', 'Diana', 'Elena', 'Freya', 'Gwen', 'Helena', 'Iris', 'Julia', 'Kira', 'Luna', 'Maya', 'Nora', 'Ophelia', 'Piper', 'Quinn', 'Rosa', 'Stella', 'Thea'],
    neutral: ['Alex', 'Blake', 'Casey', 'Drew', 'Ellis', 'Finley', 'Gray', 'Harper', 'Indigo', 'Jordan', 'Kai', 'Lake', 'Morgan', 'Nico', 'Onyx', 'Phoenix', 'River', 'Sage', 'Sky', 'Winter'],
  },
  elf: {
    male: ['Aelrindel', 'Caelum', 'Elrond', 'Faelar', 'Galion', 'Haldir', 'Ilithien', 'Legolas', 'Mirion', 'Orion', 'Silvain', 'Thranduil', 'Valandil'],
...
const SURNAMES = {
  human: ['Blackwood', 'Brightblade', 'Darkwater', 'Goldshire', 'Ironforge', 'Lightbringer', 'Nightfall', 'Redmane', 'Shadowmere', 'Silverstone', 'Stormwind', 'Winterhold'],
...
const APPEARANCE_DESCRIPTORS = {
  ...
  feature: ['scarred face', 'tattooed arms', 'missing finger', 'crooked nose', 'perfect teeth', 'weathered hands', 'graceful movements', 'imposing presence', 'infectious smile'],
}
...
class RandomGeneratorService {
  ...
  assignAttributesForClass(scores: number[], characterClass: CharacterClass): Attributes {
    ...
    for (const [index, stat] of classPriorities.entries()) {
