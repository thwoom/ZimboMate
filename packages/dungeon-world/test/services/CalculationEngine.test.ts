...
import { Armor,Item, Weapon } from '../../src / models / Equipment';
import { createEmptyInventory,Inventory } from '../../src / models / Inventory';
import { ModifierSet } from '../../src / models / Modifiers';
import { CalculationContext,calculationEngine } from '../../src / services / CalculationEngine';
...
describe('CalculationEngine', () => {
  ...
  const createTestInventory = (): Inventory => {
    const _inv = createEmptyInventory();
  ...
  describe('calculate', () => {
    it('should calculate basic values correctly', () => {
      ...
      const _result = calculationEngine.calculate(context);
    ...
    it('should calculate encumbrance correctly', () => {
      const _character = createTestCharacter();
      const _inventory = createTestInventory();
